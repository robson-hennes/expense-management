...
class IncomeController extends Controller
{
    public function index(Request $request)
    {
        ...
        if ($request->ajax()) {
            $query = Income::with(['income_category', 'users'])->select(sprintf('%s.*', (new Income())->table));
            ...
            $table->addColumn('users_email', function ($row) {
                return $row->users ? $row->users->email : '';
            });
            ...
            $table->rawColumns(['actions', 'placeholder', 'income_category', 'users']);
    ...
    public function create()
    {
        ...
        return view('admin.incomes.create', compact('income_categories', 'users'));
    }
    ...
    public function edit(Income $income)
    {
        ...
        $income->load('income_category', 'users');

        return view('admin.incomes.edit', compact('income_categories', 'users', 'income'));
    }
